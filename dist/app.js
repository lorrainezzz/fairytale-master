...
app.use('/', indexRouter);
app.use('/users', usersRouter); // Our Custom Donation Web App Routes
...
app.get('/user/:uname', user.findOne); //app.get('/author/search/:aname', author.searchAuthor);
...
app.delete('/author/:id', author.deleteAuthor); // catch 404 and forward to error handler
